...
@Controller('moduloTurnos')
export class ModuloDeTurnoController {
  constructor(
  ...
  //UseCase: SolicitarTurno
  @Get('solicitarTurnoEspecialidades')
  solicitarTurnoEspecialidades() {
    return this.useCaseSolicitarTurno.solicitarTurnoEspecialidades();
  }
  @Get('solicitarTurnoLocalidades/:idEspecialidad')
  solicitarTurnoLocalidades(@Param('idEspecialidad') idEspecialidad: string) {
    return this.useCaseSolicitarTurno.solicitarTurnoLocalidades(
      Number(idEspecialidad),
    );
  }
