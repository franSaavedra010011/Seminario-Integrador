...
let UsuarioController = class UsuarioController extends abm_base_controller_1.AbmBaseController {
    constructor(abmUsuarioUseCase, genericRepositoryService) {
        super(abmUsuarioUseCase, genericRepositoryService, usuario_entity_1.Usuario);
    }
};
