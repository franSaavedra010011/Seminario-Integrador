...
let EstadoTurnoController = class EstadoTurnoController extends abm_base_controller_1.AbmBaseController {
    constructor(abmEstadoTurnoUseCase, genericRepositoryService) {
        super(abmEstadoTurnoUseCase, genericRepositoryService, estado_turno_entity_1.EstadoTurno);
    }
};
